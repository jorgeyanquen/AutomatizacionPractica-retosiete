...
import com.practicasiete.Step.HeroKuappJavasScriptStep;
...
public class HeroKuappValidationDefinitions {
    ...
    @Steps
    HeroKuappJavasScriptStep heroKuappJavasScriptStep;
    ...
    public void interacts_with_the_controls_on_this_screen()  {
        ...
        heroKuappJavasScriptStep.validacion_botones_HeroKuapp();
